...
Codex skill for writing custom Hong Kong forum-style 潮文 in Traditional Chinese/Cantonese. It takes a user topic, opinion, product, event, or statement, then rewrites it using the structure and rhythm of a referenced 潮文.

Traditional Chinese version: `README.zh-Hant.md`
